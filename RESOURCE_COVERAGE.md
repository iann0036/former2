...
KafkaSettings: [X]
    Broker: [X]
    SaslPassword: [X]
    SslClientCertificateArn: [X]
    IncludeTransactionDetails: [X]
    SecurityProtocol: [X]
    IncludeTableAlterOperations: [X]
    SslCaCertificateArn: [X]
    IncludeControlDetails: [X]
    NoHexPrefix: [X]
    SslClientKeyArn: [X]
    SslClientKeyPassword: [X]
    SaslUserName: [X]
    Topic: [X]
    PartitionIncludeSchemaTable: [X]
    IncludeNullAndEmpty: [X]
Port: [X]
MySqlSettings: [ ]
S3Settings: [X]
